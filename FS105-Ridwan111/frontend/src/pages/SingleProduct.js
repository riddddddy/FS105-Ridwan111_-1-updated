...
const SingleProduct = () => {
  ...
  const getSingleProduct = async (req, res) => {
    ...
    try {
      const product = await fetch(`https://fs105-ridwan111-1-updated.onrender.com/api/products/${bagName}`)
  ...
  const wishListHandler = async () => {
    ...
    const response = await fetch(`https://fs105-ridwan111-1-updated.onrender.com/api/wishlist/addwishlist/`, {
      method: "POST",
      headers: {
  ...
  const handleAddToCart = async () => {
    ...
    const response = await fetch('https://fs105-ridwan111-1-updated.onrender.com/api/cart', {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
